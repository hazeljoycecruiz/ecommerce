    ...
    public function updateUser()
{
    try {
        ...
        $invalidatedQuery = "SELECT * FROM user_tokens WHERE token_id = :token_id AND user_id = :user_id";
        $invalidatedStmt = $this->db->prepare($invalidatedQuery);
        $invalidatedStmt->bindParam(':token_id', $this->token);
        ...
        if (empty($this->data->first_name) && empty($this->data->last_name) && empty($this->data->phone_num)) {
